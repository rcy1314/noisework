(function(){
  ...
  */
  let command ={
      'echo':{
          'fun':cmecho,
          'help':'用法: echo [字符串] [-h]<br>字符串: 输出的内容<br>-h: 显示帮助信息。',
          'parameters':['-h'],
          'nap':-1
      },
      'test':{
      ...
      'ls':{
          'fun' :cmls,
          'help' :'用法: ls [目录] [-h]<br>目录: 文件或文件夹的路径。<br>-h: 显示帮助信息。',
          'parameters':['-h'],
          'nap':1
      },
      'help':{
      ...
      'cat':{
          'fun' :cmcat,
          'help' :'用法: cat [文件] [-h]<br>文件: 文件的路径。<br>-h: 显示帮助信息。',
          'parameters':['-h'],
          'nap':1
      },
      'visit':{
